            ...
            {cashFlowStatementDto
                ? <div>
                                ...
                                return(
                                    <React.Fragment key={account.accountId}>
                                        <AccountInReport
                                            ...
                                            amounts={negateArrayOfNumbers(account.amounts)}
                                            ...
                                            if (!accountIsEmpty(child)) {
                                                return(
                                                    <AccountInReport
                                                        ...
                                                        amounts={negateArrayOfNumbers(child.amounts)}
                    ...
                    <ReportRow
                        ...
                        isCurrency
                        className="fw-bold report-header border-top-0 mt-5"
                    />   
                    {/** Interest paid */}
                    <ReportRow
                        ...
                        isCurrency
                        className="fw-semibold mt-5 border-top-0"
                    />
