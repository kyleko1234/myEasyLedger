                                            ...
                                            {this.state.accounts.filter(account => account.accountTypeId == accountType.id && !account.parentAccountId).map(account => { // render a bg-light accountgroup widget list item for each accountGroup in this accountType, then render all of the accounts for at accountGroup
                                                return (
                                                    <React.Fragment key={account.accountId}>
                                                        ...
                                                        :
                                                        <Link className="pseudo-tr d-flex justify-content-between align-items-center " to={`/category-details/${account.accountId}`}>
                                                                <div className="pseudo-td fw-semibold">
                                                                    {account.accountCode ? account.accountCode + " - " + account.accountName : account.accountName}
                                                                </div>
                                                                <div className="pseudo-td py-0 d-flex align-items-center">
                                                        ...
                                                        {!this.state.accounts 
                                                            ...
                                                            : this.state.accounts
                                                                ...
                                                                .map(childAccount => {
                                                                    return (
                                                                        <Link className="pseudo-tr d-flex justify-content-between align-items-center " to={`/category-details/${childAccount.accountId}`} key={childAccount.accountId}>
