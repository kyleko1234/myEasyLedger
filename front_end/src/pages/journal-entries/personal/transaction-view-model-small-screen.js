...
function TransactionViewModelSmallSreen({ journalEntryDate, accountName, description, debitAmount, creditAmount, onClick }) {
...
export default TransactionViewModelSmallSreen;