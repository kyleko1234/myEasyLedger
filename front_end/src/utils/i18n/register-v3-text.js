...
export const registerV3Text = {
    "en-US": {
        ...
        "Sign Up": "Sign Up",
        "Create your Easy Ledger Account.": "Create your My Easy Ledger Account.",
        "Name": "Name",
        ...
        "Already a member": <div>Already a member? Click <Link to="/user/login-v3" className="text-primary">here</Link> to login.</div>,
        "Copyright text": "\u00A9 2021 MyEasyLedger.tw All Rights Reserved."
    },
    "zh-TW": {
        "App description": "APP 描述",
        "Sign Up": "建立新使用帳號",
        "Create your Easy Ledger Account.": "建立一個新的 My Easy Ledger 帳號。",
        "Name": "您的名字",
        "First name": "名",
        "Last name": "姓",
        "Email": "您的電子郵箱",
        "Email address": "電郵址",
        "Email is already taken.": "該電郵已有 My Easy Ledger 的帳號在使用中。",
        "Re-enter Email": "再次輸入電郵址",
        "Re-enter email address": "再一次輸入你的電郵址",
        "Email does not match.": "輸入的電郵址前後不符。",
        "Organization Name": "公司、組織、或專案名稱",
        "Password": "密碼",
        ...
        "Please agree.": "請同意。",
        "Already a member": <div>已經有帳號了嗎？點擊 <Link to="/user/login-v3" className="text-primary">這裡</Link> 就可以登入。</div>,
