export const API_BASE_URL = 'http://localhost:8080/v0.6.1';
...
export const PIE_CHART_BORDER_COLORS = [
    ...
    "rgba(55, 173, 242, 1)", "rgba(185, 221, 255, 1)", "rgba(255, 220, 204, 1)", "rgba(254, 188, 40, 1)", "rgba(254, 154, 8, 1)", "rgba(255, 73, 60, 1)", "rgba(254, 7, 51, 1)", "rgba(236, 108, 164, 1)", "rgba(201, 14, 143, 1)", "rgba(131, 59, 133, 1)", "rgba(73, 59, 121, 1)"
]
export const PIE_CHART_BACKGROUND_COLORS = [
    ...
    "rgba(55, 173, 242, 0.7)", "rgba(185, 221, 255, 0.7)", "rgba(255, 220, 204, 0.7)", "rgba(254, 188, 40, 0.7)", "rgba(254, 154, 8, 0.7)", "rgba(255, 73, 60, 0.7)", "rgba(254, 7, 51, 0.7)", "rgba(236, 108, 164, 0.7)", "rgba(201, 14, 143, 0.7)", "rgba(131, 59, 133, 0.7)", "rgba(73, 59, 121, 0.7)"
]
